...
$price = ((isset($_POST['price']) && $_POST['price'] != '')?sanitaze($_POST['price']):'');
$list_price = ((isset($_POST['list_price']) && $_POST['list_price'] != '')?sanitaze($_POST['list_price']):'');
$description = ((isset($_POST['description']) && $_POST['description'] != '')?sanitaze($_POST['description']):'');
$sizes = ((isset($_POST['sizes']) && $_POST['sizes'] != '')?sanitaze($_POST['sizes']):'');
$sizes = rtrim($sizes,',');
$saved_image = '';
if(isset($_GET['edit'])){
  ...
  $title = ((isset($_POST['title']) && $_POST['title'] != '')?sanitaze($_POST['title']):$product['title']);
  $brand = ((isset($_POST['brand']) && $_POST['brand'] != '')?sanitaze($_POST['brand']):$product['brand']);
  ...
  $price = ((isset($_POST['price']) && $_POST['price'] != '')?sanitaze($_POST['price']):$product['price']);
  $list_price = ((isset($_POST['list_price']))?sanitaze($_POST['list_price']):$product['list_price']);
  $description = ((isset($_POST['description']))?sanitaze($_POST['description']):$product['description']);
  $sizes = ((isset($_POST['sizes']) && $_POST['sizes'] != '')?sanitaze($_POST['sizes']):$product['sizes']);
  $sizes = rtrim($sizes,',');
  $saved_image = (($product['image'] != '')?$product['image']:'');
  $dbpath = $saved_image;
}
if (!empty($sizes)) {
  $sizeString = sanitaze($sizes);
